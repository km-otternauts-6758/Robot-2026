...
FUDGE_DIST_LEFT_RIGHT_RED = (
    [  # Positive is to the robot's left, negative is to the robot's right
...
SCORE_DIST_FROM_REEF_CENTER = (
    REEF_RADIUS + WHEEL_BASE_HALF_LENGTH_M + BUMPER_THICKNESS_M
)
